program phase_matrix_explicit
 ...
 real :: cx(0:Manl),cm(0:Manl),cms(0:Manl),ci(0:Manl),cio(0:Manl),cou(0:Manl),catm
 Nl=3; St=0.25; LnBoMp=(/2,3/); LnTpMpSr=(/1,2/)
 do c=0,15
   Ioptmp=mod(c,2)
   Flib=0.;Flio=0.;Flou=0.;He=0.;Mofr=0.;Mofro=0.;Mofrsa=0.;Mofrt=0.;Mofrox=0.;MofrsaMp=0.;SrWaMpCp=0.;Mofrtx=0.;a=0.;b=0.;d=0.;e=0.;f=0.;g=0.;s=0.;cx=0.;cm=0.;cms=0.;ci=0.;cio=0.;cou=0.;catm=0.
   ...
   enddo
   Itask=1; call ghg_phase_kernel(Itask,Ioptmp,LnBoMp,LnTpMpSr,Nl,St,Flib,Flio,Flou,He,Mofr,Mofro,Mofrsa,Mofrt,Mofrox,MofrsaMp,SrWaMpCp,Mofrtx,cx,cm,cms,ci,cio,cou,catm,a,b,d,e,f,g,s)
   call clobber()
   Itask=2; call ghg_phase_kernel(Itask,Ioptmp,LnBoMp,LnTpMpSr,Nl,St,Flib,Flio,Flou,He,Mofr,Mofro,Mofrsa,Mofrt,Mofrox,MofrsaMp,SrWaMpCp,Mofrtx,cx,cm,cms,ci,cio,cou,catm,a,b,d,e,f,g,s)
